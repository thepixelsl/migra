...
export const desktopNavigationItems: NavigationItem[] = [
  ...
  },
  {
    label: "Blog",
    href: "/blog/",
    description: "Blog, Standesämter, Trautermine und Hochzeitsratgeber",
    seoContext: "Blog Hochzeitsfotograf Hamburg",
    trackingId: "desktop_blog",
    ctaType: "navigation",
    contentTopic: "blog",
    userIntent: "blog_lesen",
    journeyStage: "information",
    children: [
      {
        label: "Planung",
        href: "/blog/",
        trackingId: "desktop_blog_planning",
        ctaType: "navigation",
