...
<p><strong>Stand: 18. September 2026</strong></p>
...
<p>Für die technische Nutzungs- und Missbrauchsauswertung protokollieren wir diese Terminprüfungen für höchstens 30 Tage: Zeitpunkt, angefragte Daten, Ergebnis, HTTP-Status, Zugangsweg (zum Beispiel FAB oder API) sowie eine abgeleitete Browser-, Bot- oder Dienst-Kategorie mit Herkunftshinweis. Eine Prüfung gegen öffentlich veröffentlichte Anbieter-IP-Bereiche erfolgt auf unserem Server; dabei wird die Absender-IP nicht an den Anbieter übermittelt oder in diesem Protokoll gespeichert. Es werden keine zusätzlichen Tracking-Cookies gesetzt. Browserabfragen lassen nicht zuverlässig erkennen, ob ein Mensch oder ein KI-Assistent den Browser bedient. Die Auswertung enthält auch Häufigkeiten je Wunschtermin und Hinweise auf breite oder fortlaufende Kalenderabfragen.</p>
