...
const consentSection = numberedSection(
  ...
  "Cookies und Einwilligungen",
  `<p>Für technisch nicht erforderliche Statistik- und Marketingdienste holen wir vor dem Laden des jeweiligen Dienstes Ihre Einwilligung ein. Statistik und Marketing können getrennt gewählt werden. Zusätzlich können Sie Google Analytics 4, Microsoft Clarity und Meta Pixel im Banner einzeln auswählen. Dort können Sie auch die eingesetzten Service-Gruppen, Services und Provider mit ihren jeweiligen Angaben einsehen. Eine Ablehnung hat keinen Einfluss auf die grundlegende Nutzung dieser Website.</p>
...
<p>Microsoft Clarity und das Meta Pixel werden erst nach Ihrer Einwilligung in den jeweiligen Service geladen. Für Google Tag Manager und Google Analytics 4 verwenden wir den erweiterten Einwilligungsmodus. Dabei werden die Google-Tags bereits mit standardmäßig abgelehnten Einwilligungssignalen geladen; Einzelheiten finden Sie in den folgenden Abschnitten.</p>`,
);
...
<p>Wir verwenden den erweiterten Einwilligungsmodus von Google. Der Tag Manager wird auf öffentlichen Seiten bereits vor Ihrer Auswahl geladen. Zuvor werden <code>analytics_storage</code>, <code>ad_storage</code>, <code>ad_user_data</code> und <code>ad_personalization</code> auf „denied“ gesetzt. Google kann dadurch den Einwilligungsstatus sowie reduzierte, cookielose Messsignale erhalten. Analytics- oder Werbe-Cookies werden dabei nicht gesetzt. Microsoft Clarity und Meta Pixel sind als nicht Google-eigene Tags zusätzlich gesperrt und werden erst bei einer Einwilligung in den jeweiligen Service ausgelöst.</p>
...
<p>Für die vor Ihrer Auswahl erfolgende Übermittlung abgelehnter Einwilligungssignale und reduzierter Messsignale berufen wir uns auf Art. 6 Abs. 1 lit. f DSGVO. Unser berechtigtes Interesse liegt in der einheitlichen technischen Steuerung der Einwilligung und einer aggregierten Beurteilung der Website-Nutzung ohne Analytics- oder Werbe-Cookies. Für die darüber hinausgehende Statistik- oder Marketingverarbeitung gelten Ihre Einwilligung nach Art. 6 Abs. 1 lit. a DSGVO und, soweit Informationen auf Ihrem Endgerät gespeichert oder ausgelesen werden, § 25 Abs. 1 TDDDG. Weitere Angaben enthalten Googles Dokumentation zum <a href="https://developers.google.com/tag-platform/security/concepts/consent-mode?hl=de" rel="noopener noreferrer" target="_blank">Einwilligungsmodus</a>, die Hinweise zu <a href="https://support.google.com/tagmanager/answer/9323295?hl=de" rel="noopener noreferrer" target="_blank">Datenschutz und Sicherheit im Tag Manager</a> sowie die <a href="https://policies.google.com/privacy?hl=de" rel="noopener noreferrer" target="_blank">Datenschutzerklärung von Google</a>.</p>`,
);
...
<p>Google Analytics 4 läuft im erweiterten Einwilligungsmodus. Ohne Ihre Einwilligung in den Service „Google Analytics 4“ bleiben <code>analytics_storage</code> und die weiteren optionalen Speicherarten abgelehnt; Google kann dann reduzierte Messsignale ohne Analytics-Cookies erhalten. Erst nach Ihrer Einwilligung wird <code>analytics_storage</code> freigegeben und die vollständige, cookie-basierte Statistikverarbeitung aktiviert. Für die Verarbeitung nach Einwilligung gelten Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG. Sie können die Einwilligung jederzeit über „Datenschutz-Einstellungen“ für die Zukunft widerrufen.</p>
