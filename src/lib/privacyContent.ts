...
<p>Zusätzlich protokollieren wir für höchstens 30 Tage eine grobe Bot-Kategorie, die Art und das Ergebnis einer optionalen technischen Identitätsprüfung, die konkret angefragten Wunschdaten, das jeweilige Verfügbarkeitsergebnis, den HTTP-Status und den Zeitpunkt der Anfrage. Die vollständige IP-Adresse, der vollständige User-Agent und ein optional übermittelter API-Schlüssel werden nicht gespeichert. Eine anhand des User-Agents erkannte Bot-Kategorie ist nicht verifiziert und wird in der geschützten Ansicht entsprechend gekennzeichnet.</p>
